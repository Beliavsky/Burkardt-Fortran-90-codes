...
!
  ...
  integer it
  integer j
  integer kit(n1:n2,nrmax)
  integer, parameter :: kprint = 0
  integer m
  integer, parameter :: m0 = 1
  integer, allocatable, dimension ( : ) :: mj
  integer n
  integer nr
