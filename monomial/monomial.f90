...
!    0 <= N1 <= N2.
!
!    Output, integer MONO_BETWEEN_ENUM, the number of monomials 
...
subroutine mono_between_random ( m, n1, n2, rank, x )
...
!
  ...
  rank = i4_uniform_ab ( rank_min, rank_max )
...
subroutine mono_total_random ( m, n, rank, x )
...
subroutine mono_upto_random ( m, n, rank, x )
