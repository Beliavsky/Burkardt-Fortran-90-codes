...
!*****************************************************************************80
!
!! sandia_sgmgg_test() tests sandia_sgmgg().
!
!  Licensing:
!
...
!
  ...
  integer d2
  integer d3
  integer, allocatable :: gg_a(:)
  integer, allocatable :: gg_b(:,:)
  integer, allocatable :: gg_f(:,:)
  real ( kind = rk ), allocatable :: gg_g(:)
  integer, allocatable :: gg_i(:,:)
  integer gg_ma
  integer gg_mi
  integer gg_mo
  integer gg_na
  ...
  integer gg_ni
  integer gg_no
  integer, allocatable :: gg_o(:)
  integer, allocatable :: gg_s(:)
  integer i
  integer i4_wrap
  integer indx_max
  integer indx_nab
...
!
  ...
  integer, parameter :: point_num = 8

  integer point_num2
  integer, dimension ( 2, 8 ) :: sparse_index = reshape ( (/ &
    0, 0, &
    0, 1, &
    0, 2, &
    0, 3, &
...
!
  ...
  integer i
  integer j
  integer, dimension ( m, n1 ) :: s1 = reshape ( (/ &
    0, 2, &
    1, 1, &
    2, 0, &
    0, 1, &
...
!
  ...
  integer neighbor(dim_num,point_num)
  integer sparse_index(dim_num,point_num)
