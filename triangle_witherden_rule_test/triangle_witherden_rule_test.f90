...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) '' 
  write ( *, '(a)' ) 'triangle_witherden_rule_test():'
  write ( *, '(a)' ) '  Fortan90 version'
  write ( *, '(a)' ) '  Test triangle_witherden_rule().'

  p = 5
  call triangle_witherden_rule_test01 ( p )

  p = 5
  call triangle_witherden_rule_test02 ( p )

  p_lo = 0
  p_hi = 20
  call triangle_witherden_rule_test03 ( p_lo, p_hi )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine triangle_witherden_rule_test01 ( p )

!*****************************************************************************80
!
!! triangle_witherden_rule_test01() computes a quadrature rule of precision P.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'triangle_witherden_rule_test01():'
  write ( *, '(a)' ) '  Quadrature rule for the triangle,'
...
!
  ...
  call triangle_witherden_rule ( p, n, a, b, c, w )
!
!  Print the rule.
!
  write ( *, '(a)' ) ''
...
subroutine triangle_witherden_rule_test02 ( p )

!*****************************************************************************80
!
!! triangle_witherden_rule_test02() tests a triangle quadrature rule of precision P.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  integer t
  real ( kind = rk ) triangle_unit_area
  real ( kind = rk ) triangle_unit_monomial_integral
  real ( kind = rk ), allocatable :: v(:)
  real ( kind = rk ), allocatable :: w(:)
  real ( kind = rk ), allocatable :: xy(:,:)

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'triangle_witherden_rule_test02():'
  write ( *, '(a)' ) '  Test the precision of a quadrature rule for the unit triangle,'
...
!
  ...
  do degree = 0, p + 2
    ...
    do while ( .true. )
      ...
      quad = triangle_unit_area ( ) * dot_product ( w, v )
...
subroutine triangle_witherden_rule_test03 ( p_lo, p_hi )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'triangle_symq_rule_test03():'
  write ( *, '(a)' ) '  Test the precision of a quadrature rule for the unit triangle,'
