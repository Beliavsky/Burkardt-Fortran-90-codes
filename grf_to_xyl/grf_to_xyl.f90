...
!*****************************************************************************80
!
!! grf_to_xyl() converts a GRF file to XY and XYL files.
!
!  Usage:
!
!    grf_to_xyl file.grf
...
!
!    Input, real ( kind = rk8 ) XY(2,NODE_NUM), the node coordinates.
!
  implicit none
  ...
  integer edge
  integer edge_data(edge_num)
  integer edge_pointer(node_num+1)
  integer node
  real ( kind = rk8 ) xy(2,node_num)
...
!
!    Output, real ( kind = rk8 ) XY(2,NODE_NUM), the node coordinates.
!
  implicit none
