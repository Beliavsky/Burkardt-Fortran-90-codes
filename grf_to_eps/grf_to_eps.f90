...
!
!    Input, real ( kind = rk ) X(NNODE), Y(NNODE), the points.
!
  implicit none
...
!  Parameters:
!
!    Input, integer INPUT_UNIT, the FORTRAN unit number associated
...
!
  ...
  integer, parameter :: maxedge = 5000
