...
!
!    Input, real ( kind = rk ) NODE_XY(2,3), the coordinates of the nodes
!    of the triangle.
!
...
!
!    Input, real ( kind = rk ) POINT_XY(2,POINT_NUM), the coordinates of the
!    points.
!
...
!
  ...
  integer point
  integer point_show
  real ( kind = rk ) point_xy(2,point_num)
