...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'rk2_implicit_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test rk2_implicit().'

  tspan(1) = 0.0D+00
  tspan(2) = 2.0D+00
  call humps_exact ( 1, tspan(1), y0 )
  n = 50
  call humps_test ( tspan, y0, n )
...
subroutine humps_test ( tspan, y0, n )

!*****************************************************************************80
!
!! humps_test() calls rk2_implicit() for the humps problem.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  integer data_unit
  character ( len = * ), parameter :: header = 'humps'
  ...
  call rk2_implicit ( humps_deriv, tspan, y0, n, m, t, y )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  humps_test(): data stored in "' &
    // trim ( data_filename ) // '".'
!
...
!
  ...
  write ( command_unit, '(a)' ) 'set title "rk2_implicit(): Humps ODE"'
  ...
  write ( *, '(a)' ) '  humps_test(): plot commands stored in "' &
...
!*****************************************************************************80
!
!! predator_prey_test(): predator-prey using rk2_implicit().
!
!  Discussion:
!
...
!
  ...
  write ( *, '(a)' ) '  of predators and prey are solved using rk2_implicit().'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  The exact solution shows periodic behavior, with a fixed'
  write ( *, '(a)' ) '  period and amplitude.'

  call rk2_implicit ( predator_prey_dydt, tspan, y0, n, m, t, y )
!
!  Create the data file.
!
  call get_unit ( data_unit )
...
!*****************************************************************************80
!
!! stiff_test() uses rk2_implicit() on the stiff ODE.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'stiff_test():'
  write ( *, '(a)' ) '  Solve stiff ODE using rk2_implicit()'

  call rk2_implicit ( stiff_dydt, tspan, y0, n, m, t1, y1 )
