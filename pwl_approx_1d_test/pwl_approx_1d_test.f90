...
!
  ...
  integer, parameter :: nc_test_num = 4
  integer, parameter :: nd_test_num = 2

  integer j
  integer k
  integer nc
  integer, dimension(nc_test_num) :: nc_test = (/ 2, 4, 8, 16 /)
  integer nd
  integer, dimension(nd_test_num) :: nd_test = (/ 16, 64 /)
  integer prob
  integer prob_num
