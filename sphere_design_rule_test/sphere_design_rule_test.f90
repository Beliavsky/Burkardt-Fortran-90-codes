...
!
  ...
  integer order_max
  real ( kind = rk8 ) quad
  real ( kind = rk8 ), parameter :: r = 1.0D+00
  real ( kind = rk8 ) sphere_area
  real ( kind = rk8 ), allocatable :: x(:,:)
  real ( kind = rk8 ), dimension ( 3 ) :: xc = (/ 0.0D+00, 0.0D+00, 0.0D+00 /)
...
!
  ...
  integer order_max
  real ( kind = rk8 ) quad
  real ( kind = rk8 ), parameter :: r = 2.0D+00
  real ( kind = rk8 ) sphere_area
  real ( kind = rk8 ), allocatable :: x(:,:)
  real ( kind = rk8 ), dimension ( 3 ) :: xc = (/ 1.0D+00, 2.0D+00, 3.0D+00 /)
