...
!
!    Output, real ( kind = rk ) L(M), U(M), the lower and upper bounds.
!
  implicit none
...
!
!    Output, real ( kind = rk ) VALUE(N), the value of the function at X.
!
  implicit none
...
!
  ...
  do i = 1, m
    ...
    s2(1:n) = s2(1:n) + 0.5D+00 * real ( i, kind = rk ) * x(i,1:n)
  end do
