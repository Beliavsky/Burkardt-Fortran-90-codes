...
!
  ...
  do i = 0, nx
    x2 = real ( i, kind = 8 ) * xmax / real ( nx, kind = 8 )
    y2 = ymin
    call ps_moveto ( x2, y2 )
    y2 = ymax
  ...
  do j = 0, ny
    x2 = xmin
    y2 = real ( j, kind = 8 ) * ymax / real ( ny, kind = 8 )
    call ps_moveto ( x2, y2 )
    x2 = xmax
    call ps_lineto ( x2, y2 )
  end do
...
!
  ...
  x(1) = ( ( nx - i + 1 ) * xmin + ( i - 1 ) * xmax ) / real ( nx, kind = 8 )
  y(1) = ( ( ny - j + 1 ) * ymin + ( j - 1 ) * ymax ) / real ( ny, kind = 8 )
  x(2) = ( ( nx - i     ) * xmin +   i       * xmax ) / real ( nx, kind = 8 )
  y(2) = ( ( ny - j + 1 ) * ymin + ( j - 1 ) * ymax ) / real ( ny, kind = 8 )
  x(3) = ( ( nx - i     ) * xmin +   i       * xmax ) / real ( nx, kind = 8 )
  y(3) = ( ( ny - j     ) * ymin +   j       * ymax ) / real ( ny, kind = 8 )
  x(4) = ( ( nx - i + 1 ) * xmin + ( i - 1 ) * xmax ) / real ( nx, kind = 8 )
  y(4) = ( ( ny - j     ) * ymin +   j       * ymax ) / real ( ny, kind = 8 )
