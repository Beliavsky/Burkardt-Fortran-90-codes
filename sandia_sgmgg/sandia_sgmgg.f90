...
!
!    Input, real ( kind = rk ) A(*), the data vector.
!
...
!
!    Input, real ( kind = rk ) GG_G(GG_MA), the error estimators.
!
...
!
  ...
  integer gg_a(gg_ma)
  integer gg_b(gg_nd,gg_mi)
  integer gg_f(gg_nd,gg_mi)
  real ( kind = rk ) gg_g(gg_mi)
  integer gg_i(gg_nd,gg_mi)
  integer gg_na
  integer gg_ni
  integer gg_no
  integer gg_o(gg_mo)
