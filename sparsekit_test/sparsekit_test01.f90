...
!*****************************************************************************80
!
!! sparsekit_test01() tests  sparsekit().
!
!  Modified:
!
!    17 August 2008
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'sparsekit_test01():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test sparsekit().'
  ...
  call ope_01 (n,x,y1,a,ja,ia)
  call ope_01 (n,x,y,b,jb,ib)
  do j=1, n
    y1(j) = s*y(j) + y1(j)
  end do

  call ope_01 (n,x,y,c,jc,ic)
...
subroutine ope_01 ( n, x, y, a, ja, ia )
 
!*****************************************************************************80
!
!! ope_01() computes A * x for a sparse matrix A.
!
  implicit none
...
subroutine opet_01 ( n, x, y, a, ja, ia )

!*****************************************************************************80
!
!! opet_01() computes A' * x for a sparse matrix A.
!
  implicit none
