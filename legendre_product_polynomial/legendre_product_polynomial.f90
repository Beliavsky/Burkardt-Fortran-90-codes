...
!
!    Output, real ( kind = rk ) V(N), the values of the Legendre polynomials 
...
!
  ...
  if ( 1 <= o ) then
    ...
    do j = 2, o
      ...
      vtable(1:n,j) = &
        ( real ( 2 * j - 1, kind = rk ) * x(1:n) * vtable(1:n,j-1)   &
...
!
!    Output, real ( kind = rk ) VALUE(N), the value of the Legendre Product 
