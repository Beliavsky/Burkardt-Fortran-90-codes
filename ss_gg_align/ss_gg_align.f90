...
!  Parameters:
!
!    Input, integer I, the index of an amino acid, between 1 
!    and 23.
!
...
!
!    Input, integer A1(N), A2(N), contain the two components of 
!    each item.
!
...
!
!    Input, integer STACK_MAX, the maximum number of items in 
!    the stack.
!
  implicit none
