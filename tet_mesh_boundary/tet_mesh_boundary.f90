...
!*****************************************************************************80
!
!! tet_mesh_boundary() determines the triangles bounding a tetrahedral mesh.
!
!  Discussion:
!
