...
!
!    Input, real ( kind = rk ) NODE_XYZ(DIM_NUM,NODE_NUM), the node coordinates.
!
...
!
  ...
  integer triangle_node(order_num,triangle_num)
...
!    Input, integer TRIANGLE_NUM, the number of triangles.
!
!    Output, real ( kind = rk ) NODE_XYZ(DIM_NUM,NODE_NUM), the node coordinates.
!
