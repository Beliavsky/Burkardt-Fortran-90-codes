...
!    0 <= N.
!
!    Input/output, integer X(M), the current monomial.
...
!  Parameters:
!
!    Input, integer M, the number of parts in the composition.
!    1 <= KC.
!
...
!  Parameters:
!
!    Input, integer M, the number of parts of the composition.
!    1 <= KC.
!
...
!    Input, integer N, the maximum degree.
!
!    Output, integer MONO_UPTO_ENUM, the number of monomials in
...
!
!    Output, integer O2, the "order" of the polynomial derivative.
!
!    Output, real ( kind = rk ) C2(O2), the coefficients of the polynomial 
!    derivative.
!
!    Output, integer E2(O2), the indices of the exponents of the
