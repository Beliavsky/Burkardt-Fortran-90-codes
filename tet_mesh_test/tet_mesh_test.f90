...
!
  ...
  integer seed
  real ( kind = rk ), dimension(3,4) :: tet = reshape ( (/ &
...
!
  ...
  integer, allocatable, dimension ( :, : ) :: tet_node1
  integer, allocatable, dimension ( :, : ) :: tet_node2
  integer tet_num1
  integer tet_num2
  integer, parameter :: tet_order1 = 10
  integer, parameter :: tet_order2 = 4
...
!
  ...
  real ( kind = rk ), allocatable, dimension ( :, : ) :: node_xyz
  integer, allocatable, dimension ( :, : ) :: tet_node
  integer tet_num
  integer, parameter :: tet_order = 10
...
!
  ...
  integer seed
  integer test1
  integer, parameter :: test1_num = 3
  integer test2
  integer, parameter :: test2_num = 5
...
!
  ...
  integer node_num
  real ( kind = rk ), allocatable, dimension ( :, : ) :: node_xyz
  integer, allocatable, dimension ( :, : ) :: tet_neighbor
  integer, allocatable, dimension ( :, : ) :: tet_node
  integer tet_num
  integer, parameter :: tet_order = 4
