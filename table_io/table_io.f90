...
!
!    Output, integer TABLE2(M+2,N+2), the augmented data.
!
  implicit none
...
!    Input, integer TABLE(M,N), the data.
!
!    Output, integer TABLE2(M-2,N-2), the new data.
!
  implicit none
...
!    Input, integer N, the number of points.
!
!    Output, logical TABLE(N), the data.
!
  implicit none
...
!
!    Output, real ( kind = rk ) TABLE2(M+2,N+2), the augmented data.
!
  implicit none
...
!    Input, real ( kind = rk ) TABLE(M,N), the data.
!
!    Output, real ( kind = rk ) TABLE2(M-2,N-2), the new data.
!
  implicit none
...
!    Input, character ( len = * ) INPUT_FILENAME, the name of the input file.
!
!    Output, integer N, the number of entries.
!
  implicit none
...
!    Input, integer N, the number of points.
!
!    Output, real ( kind = rk ) X(N), Y(N), the data.
!
  implicit none
...
!    Input, character ( len = * ) S, the string to be read.
!
!    Output, logical S_TO_L4, the logical value.
!
  implicit none
