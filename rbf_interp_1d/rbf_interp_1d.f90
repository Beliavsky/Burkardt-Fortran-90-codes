...
!*****************************************************************************80
!
!! PHI5 evaluates a Wendland radial basis function.
!
!  Discussion:
!
!    Since each basis function is zero beyond a radius of R0, care must
!    be taken so that every point in the region is no further than R0 from
!    a basis point!
!
!  Licensing:
!
...
!    Volume 4, Number 1, December 1995, pages 389–396.
!
!  Parameters:
!
!    Input, integer N, the number of points.
...
subroutine phi6 ( n, r, r0, v )

!*****************************************************************************80
!
!! PHI6 evaluates a Wendland radial basis function.
!
!  Discussion:
!
!    Since each basis function is zero beyond a radius of R0, care must
...
subroutine phi7 ( n, r, r0, v )

!*****************************************************************************80
!
!! PHI7 evaluates a Wendland radial basis function.
!
!  Discussion:
!
!    Since each basis function is zero beyond a radius of R0, care must
...
!
  ...
  v(1:n) = max ( &
    1.0D+00 - ( r(1:n) / r0 ) ** 4 * ( 4.0D+00 * r(1:n) / r0 + 1.0D+00 ), &
    0.0D+00 )
