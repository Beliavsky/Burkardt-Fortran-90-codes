...
!  Output:
!
!    real ( kind = rk ) humps_antideriv: the value of the antiderivative at x.
!
  implicit none
...
!  Output:
!
!    real ( kind = rk ) humps_deriv: the value of the derivative at x.
!
  implicit none
...
!  Output:
!
!    real ( kind = rk ) humps_deriv2: the value of the second derivative at x.
!
  implicit none
...
!  Output:
!
!    real ( kind = rk ) humps_fun: the function value.
!
  implicit none
...
!    real ( kind = rk ) x: the argument.
!
!    real ( kind = rk ) y: the value of the dependent variable.
!
!  Output:
!
!    real ( kind = rk ) humps_ode: the value of the derivative of the humps function.
!
  implicit none

  integer, parameter :: rk = kind ( 1.0D+00 )

  real ( kind = rk ) humps_ode
  real ( kind = rk ) x
  real ( kind = rk ) y
  real ( kind = rk ) yp
...
!
!    real ( kind = rk ) x(n), y(n): the data points.
!
