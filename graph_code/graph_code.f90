...
!*****************************************************************************80
!
!! graph_code() computes the code for a given graph.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) '  Read information defining a graph.'
  write ( *, '(a)' ) '  Compute a code for the graph.'
!
...
!  Output:
!
!    integer CODE(NNODE,NNODE), the code.
!
!    integer ORDER(NNODE), the ordering of the nodes.
!
  implicit none
