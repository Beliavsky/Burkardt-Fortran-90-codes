...
!    character, between 1 and 26 if the character is alphabetic, 
!    and -1 otherwise.
!
  implicit none
...
!
  ...
  iseed = int ( real ( I4_MAX, kind = rk ) * temp )
!
...
!  Parameters:
!
!    Input, integer ILO, IHI, the minimum and maximum 
!    acceptable values.
!
...
!*****************************************************************************80
!
!! S_TO_I4 reads an I4 value from a string.
!
!  Licensing:
!
!    This code is distributed under the MIT license. 
...
!
!    Input, integer M1, M2, the minimum and maximum rows of 
!    the score matrix to compute.  0 <= M1 <= M2 <= M.
!
...
!    are negative.
!
!    Output, integer I1, J1, I2, J2, the "corners" of an optimal
!    local alignment.
!
  implicit none
...
!
!    Input, integer LDS, the declared upper first dimension of S,
!    E, and F.  LDS must be at least M.
!
...
!  Parameters:
!
!    Output, integer I1SUB, J1SUB, J1TYPE, real T1, the row and 
!    column of the first cell, the type of the match there, and the 
!    appropriate base.
!
!    Output, integer I2SUB, J2SUB, J2TYPE, real T2, the row and 
!    column of the second cell, the type of the match there, and the 
!    appropriate base.
!
!    Input, integer STACK1(6,STACK_MAX), real STACK2(2,STACK_MAX),
!    two arrays in which stack data is stored.
!
...
!  Parameters:
!
!    Input, integer I1SUB, J1SUB, J1TYPE, real T1, the row and 
!    column of the first cell, the type of the match there, and the 
!    appropriate base.
!
!    Input, integer I2SUB, J2SUB, J2TYPE, real T2, the row and 
!    column of the second cell, the type of the match there, and the
!    appropriate base.
!
!    Input/output, integer STACK1(6,STACK_MAX), 
!    real STACK2(2,STACK_MAX), two arrays in which stack data is stored.
!
!    Input/output, integer STACK_NUM, a pointer to the most 
!    recent item on the stack.
!
