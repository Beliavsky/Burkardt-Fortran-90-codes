...
!
!      Input, real ( kind = rk ) COORD(DIM_NUM,TRIANGLE_ORDER), the 
...
!
  ...
  real ( kind = rk ), allocatable, dimension ( :, : ) :: input_node_xy
  integer, allocatable, dimension ( : ) :: input_to_output_node

  logical, allocatable, dimension ( : ) :: input_triangle_mask
  integer, allocatable, dimension ( :, : ) :: input_triangle_node
  integer input_triangle_num
  integer j
  logical mask
  integer node
  ...
  real ( kind = rk ), allocatable, dimension ( :, : ) :: output_node_xy
  integer, allocatable, dimension ( :, : ) :: output_triangle_node
  integer output_triangle_num
