...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_jaskowiec_rule_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test prism_jaskowiec_rule().'

  p = 5
  call prism_jaskowiec_rule_test01 ( p )

  p = 5
  call prism_jaskowiec_rule_test02 ( p )

  p_lo = 0
  p_hi = 20
  call prism_jaskowiec_rule_test03 ( p_lo, p_hi )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine prism_jaskowiec_rule_test01 ( p )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_jaskowiec_rule_test01():'
...
!
  ...
  call prism_jaskowiec_rule ( p, n, x, y, z, w )
!
!  Print the rule.
!
  write ( *, '(a)' ) ''
...
subroutine prism_jaskowiec_rule_test02 ( p )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_jaskowiec_rule_test02():'
...
subroutine prism_jaskowiec_rule_test03 ( p_lo, p_hi )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_jaskowiec_rule_test03():'
