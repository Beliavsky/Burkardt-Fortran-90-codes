...
!
  ...
  integer, parameter :: triangle_num = 2
  integer, parameter :: triangle_order = 3

  real ( kind = rk ) alpha_area
  real ( kind = rk ) alpha_ave
  real ( kind = rk ) alpha_min_swapped
  real ( kind = rk ) alpha_min_unswapped
  integer diaedg
...
!
  ...
  real ( kind = rk ), dimension ( dim_num, node_num ) :: a
  integer l
  integer r
  integer :: seed = 123456789
...
!
  ...
  real ( kind = rk ) a(dim_num,node_num)
  integer :: seed = 123456789
