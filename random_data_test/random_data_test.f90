...
!
  ...
  write ( *, '(a)' ) '  Test random_data().'

  call test005 ( )
  call test01 ( )
  call grid_in_cube01_test ( )
  call test09 ( )
  ...
  call test15 ( )
  call test16 ( )
  call uniform_in_polygon_convex_test ( )
  call test18 ( )
  call test19 ( )
...
!
  ...
  do dim_num = 2, 3
    ...
    call bad_in_simplex01 ( dim_num, n, x )
...
subroutine grid_in_cube01_test ( )
...
!
  ...
  integer, parameter :: dim_num = 2
  integer, parameter :: n = 85

  integer, parameter :: center = 1
  ...
  call grid_in_cube01 ( dim_num, n, center, x )
...
!
  ...
  integer info
  real ( kind = rk ), dimension ( dim_num ) :: mu = (/ 6.0D+00, 100.0D+00 /)
  real ( kind = rk ) r(dim_num,dim_num)

  real ( kind = rk ), dimension ( dim_num, dim_num ) :: v = reshape ( (/ &
...
!
  ...
  call normal_circular ( dim_num, n, x )
...
!
  ...
  call normal_simple ( dim_num, n, x )
...
!
  ...
  real ( kind = rk ), dimension ( 2 ) :: pc = (/ 10.0D+00, 5.0D+00 /)
  real ( kind = rk ), parameter :: r1 = 1.0D+00
  real ( kind = rk ), parameter :: r2 = 3.0D+00
  ...
  call uniform_in_annulus ( pc, r1, r2, n, x )
...
!
  ...
  call uniform_in_annulus_accept ( pc, r1, r2, n, x )
...
!
  ...
  real ( kind = rk ), parameter :: theta1 = 0.0D+00
  real ( kind = rk ), parameter :: theta2 = 1.5707964D+00
  real ( kind = rk ) x(dim_num,n)
  ...
  call uniform_in_annulus_sector ( pc, r1, r2, theta1, theta2, n, x )
...
!
  ...
  call uniform_in_circle01_map ( n, x )
...
!
  ...
  call uniform_in_cube01 ( dim_num, n, x )
...
!
  ...
  real ( kind = rk ), dimension(dim_num,dim_num) :: a = reshape ( (/ &
  ...
  call uniform_in_ellipsoid_map ( dim_num, n, a, r, x )
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: v1 = (/ &
    0.75D+00, 0.90D+00 /)
  real ( kind = rk ), dimension ( dim_num ) :: v2 = (/ &
    0.00D+00, 0.20D+00 /)
  real ( kind = rk ), dimension ( dim_num ) :: v3 = (/ &
    1.10D+00, 0.65D+00 /)
  real ( kind = rk ) x(dim_num,n)
  ...
  call uniform_in_parallelogram_map ( v1, v2, v3, n, x )
...
subroutine uniform_in_polygon_convex_test ( )

!*****************************************************************************80
!
!! uniform_in_polygon_convex_test() tests uniform_in_polygon_convex().
!
!  Licensing:
!
!    This code is distributed under the MIT license. 
...
!
  ...
  character ( len = 80 ) :: output_filename = 'uniform_in_polygon_convex.txt'

  real ( kind = rk ), dimension ( dim_num, nv ) :: v = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    0.5D+00, 0.3D+00, &
    1.0D+00, 0.0D+00, &
    0.7D+00, 0.4D+00, &
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'uniform_in_polygon_convex_test():'
  write ( *, '(a)' ) '  uniform_in_polygon_convex() maps uniform '
  write ( *, '(a)' ) '  points into a convex polygon.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i8)'  ) '  Spatial dimension DIM_NUM =   ', dim_num
  write ( *, '(a,i8)'  ) '  Number of points N =          ', n
  ...
  call uniform_in_polygon_convex ( nv, v, n, x )
...
!
  ...
  real ( kind = rk ), parameter :: r1 = 1.0D+00
  real ( kind = rk ), parameter :: r2 = 2.0D+00

  real ( kind = rk ), parameter :: t1 = 0.78D+00
  real ( kind = rk ), parameter :: t2 = 2.35D+00
  real ( kind = rk ) x(dim_num,n)
  ...
  call uniform_in_sector_map ( r1, r2, t1, t2, n, x )
...
!
  ...
  call uniform_in_simplex01_map ( dim_num, n, x )
...
!
  ...
  real ( kind = rk ), dimension ( 3,4 ) :: v = reshape ( (/ &
  ...
  call uniform_in_tetrahedron ( v, n, x )
...
!
  ...
  call uniform_in_triangle_map1 ( v1, v2, v3, n, x )
...
!
  ...
  call uniform_in_triangle_map2 ( v1, v2, v3, n, x )
...
!
  ...
  call uniform_in_triangle01_map ( n, x )
...
!
  ...
  call uniform_on_ellipsoid_map ( dim_num, n, a, r, x )
...
!
  ...
  call uniform_on_hemisphere01_phong ( n, m, x )
...
!
  ...
  call uniform_on_simplex01_map ( dim_num, n, x )
...
!
  ...
  call uniform_on_sphere01_patch_tp ( n, phi1, phi2, theta1, theta2, tp )
...
!
  ...
  call uniform_on_sphere01_patch_xyz ( n, phi1, phi2, theta1, theta2, x )
...
!
  ...
  if ( .true. ) then
    ...
    call uniform_on_sphere01_map ( 3, 1, v1 )
    call uniform_on_sphere01_map ( 3, 1, v2 )
    call uniform_on_sphere01_map ( 3, 1, v3 )
  ...
  call uniform_on_sphere01_triangle_xyz ( n, v1, v2, v3, x )
