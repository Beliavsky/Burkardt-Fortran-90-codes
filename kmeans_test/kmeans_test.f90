...
!
  ...
  real ( kind = rk ), allocatable :: cluster_center(:,:)
  real ( kind = rk ), allocatable :: cluster_energy(:)
  character ( len = 255 ) :: cluster_filename = 'test01_clusters.txt'
  integer, allocatable :: cluster_population(:)
  real ( kind = rk ), allocatable :: cluster_variance(:)
  integer it_max
  integer it_num
