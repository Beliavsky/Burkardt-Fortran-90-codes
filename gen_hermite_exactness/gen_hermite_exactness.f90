...
!*****************************************************************************80
!
!! gen_hermite_exactness() investigates a generalized Gauss-Hermite quadrature rule.
!
!  Discussion:
!
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'gen_hermite_exactness: User input:'
...
!
  ...
  if ( dim_num /= 1 ) then
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'gen_hermite_exactness - Fatal error!'
