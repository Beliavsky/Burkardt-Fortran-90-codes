...
!
!    Input, integer NP(DIM_NUM), the number of parameters used by
!    each rule.
!
...
!
  ...
  integer, allocatable :: sparse_order(:,:)
  real ( kind = 8 ), allocatable :: sparse_point(:,:)
  integer, allocatable :: sparse_unique_index(:)
