...
!
  ...
  write ( *, '(a)' ) '  benford_cdf() evaluates the CDF.'
  write ( *, '(a)' ) '  benford_cdf_invert() inverts the CDF.'
  ...
  do i = 1, 10
    ...
    call benford_sample ( x )

    call benford_pdf ( x, pdf )

    call benford_cdf ( x, cdf )

    call benford_cdf_inv ( cdf, x2 )

    write ( *, '(i6,2x,g14.6,2x,g14.6,2x,i6)' ) x, pdf, cdf, x2
...
subroutine benford_sample_test ( )

!*****************************************************************************80
!
!! benford_sample_test() tests benford_sample().
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'benford_sample_test():'
  write ( *, '(a)' ) '  benford_mean() computes the mean;'
  write ( *, '(a)' ) '  benford_sample() samples the distribution;'
  write ( *, '(a)' ) '  benford_variance() computes the variance.'

  call benford_mean ( mean )
  call benford_variance ( variance )

  write ( *, '(a,g14.6)' ) '  PDF mean =        ', mean
  write ( *, '(a,g14.6)' ) '  PDF variance =    ', variance

  do i = 1, sample_num
    call benford_sample ( x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call beta_binomial_sample ( a, b, c, x )
...
!
  ...
  do i = 1, sample_num
    call beta_binomial_sample ( a, b, c, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call bradford_sample ( a, b, c, x(i) )
  end do
...
!
  ...
  do i = 1, 5
    ...
    do j = 1, 5
      ...
      do k = 0, 5
        l = real ( k, kind = rk ) * min ( a, b ) / 5.0D+00
...
!
  ...
  integer hits
  real ( kind = rk ) l
  real ( kind = rk ), parameter :: pi = 3.141592653589793238462643D+00
  real ( kind = rk ) pi_est

  integer test
  integer trial_num
  integer, dimension ( test_num ) :: trial_num_test = (/ &
  ...
  do test = 1, test_num
    ...
    if ( 0 < hits ) then
      pi_est = ( 2.0D+00 * l * ( a + b ) - l * l ) &
        * real ( trial_num, kind = rk ) &
        / ( a * b * real ( hits, kind = rk ) )
    else
      pi_est = huge ( pi_est )
    end if
...
!
  ...
  do test = 1, test_num
    ...
    if ( 0 < hits ) then
      pi_est = ( 2.0D+00 * l ) * real ( trial_num, kind = rk ) &
        / ( a * real ( hits, kind = rk ) )
    else
      pi_est = huge ( pi_est )
    end if
...
!
  ...
  real ( kind = rk ) :: a = 0.0D+00
  real ( kind = rk ) :: b = 0.25D+00
...
!
  ...
  do i = 1, sample_num
    call chi_square_noncentral_sample ( a, b, x(i) )
  end do
...
!
  ...
  real ( kind = rk ) x(2)
  real ( kind = rk ) x_table(sample_num,2)
  real ( kind = rk ) xmax(2)
  real ( kind = rk ) xmin(2)
  ...
  do i = 1, sample_num
    call circular_normal_01_sample ( x )
    x_table(i,1) = x(1)
    x_table(i,2) = x(2)
  end do
...
!
  ...
  do i = 1, sample_num
    call circular_normal_sample ( a, b, x )
    x_table(i,1) = x(1)
    x_table(i,2) = x(2)
  end do
...
!
  ...
  do n_type = 5, max_type, 5
    ...
    expect = real ( n_type, kind = rk ) * log ( real ( n_type, kind = rk ) )
    write ( *, '(a,g14.6)' ) '  Expected wait is about ', expect
    write ( *, '(a)' ) ''

    average = 0.0D+00
    do i = 1, n_trial
      call coupon_sample ( n_type, coupon, n_coupon )
      write ( *, '(2i5)' ) i, n_coupon
      average = average + real ( n_coupon, kind = rk )
    end do

    average = average / real ( n_trial, kind = rk )
    write ( *, '(a)' ) ''
...
!
  ...
  real ( kind = rk ) a
  real ( kind = rk ) atest(test_num)
  real ( kind = rk ) b
  real ( kind = rk ) btest(test_num)
  real ( kind = rk ) cdf
  real ( kind = rk ) r8_pi
...
!
  ...
  do i = 1, sample_num
    call dirichlet_sample ( n, a, x(1,i) )
  end do
...
!
  ...
  real ( kind = rk ) x(elem_num,sample_num)
  real ( kind = rk ) xmax(elem_num)
  real ( kind = rk ) xmin(elem_num)
...
!
  ...
  real ( kind = rk ), save, dimension ( a ) :: b = (/ &
    1.0D+00, 1.0D+00, 3.0D+00, 2.0D+00, 1.0D+00, 2.0D+00 /)
  real ( kind = rk ), save, dimension ( a ) :: c = (/ &
  ...
  do i = 1, 10
    ...
    call empirical_discrete_sample ( a, b, c, x )
...
!
  ...
  do i = 1, sample_num
    call empirical_discrete_sample ( a, b, c, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call english_sentence_length_sample ( x )
...
!
  ...
  do i = 1, sample_num
    call english_sentence_length_sample ( x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call english_word_length_sample ( x )
...
!
  ...
  do i = 1, sample_num
    call english_word_length_sample ( x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call exponential_01_sample ( x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call exponential_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call extreme_values_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call extreme_values_sample ( a, b, x(i) )
  end do
...
!
  ...
  integer test
  real ( kind = rk ) u
  real ( kind = rk ), dimension ( test_num ) :: u_test = (/ &
   1.0D+00, 2.0D+00, 4.0D+00, 8.0D+00, 16.0D+00, &
  32.0D+00, 1.0D+00  /)
  real ( kind = rk ) v
  real ( kind = rk ), dimension ( test_num ) :: v_test = (/ &
   1.0D+00, 1.0D+00, 1.0D+00, 1.0D+00, 1.0D+00, &
   1.0D+00, 0.25D+00  /)
  real ( kind = rk ) variance
  real ( kind = rk ) z(sample_num)
  real ( kind = rk ) z_max
  real ( kind = rk ) z_min
  ...
  do test = 1, test_num
    ...
    do i = 1, sample_num
      call fermi_dirac_sample ( u, v, z(i) )
    end do
...
!
  ...
  do test = 1, test_num
    ...
    do j = 1, n
      ...
      call fisher_sample ( kappa, mu, 1, x )
...
!
  ...
  do i = 1, 10
    ...
    call folded_normal_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call folded_normal_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call genlogistic_sample ( a, b, c, x )
...
!
  ...
  do i = 1, sample_num
    call genlogistic_sample ( a, b, c, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call half_normal_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call hypergeometric_sample ( n, m, l, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call inverse_gaussian_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call inverse_gaussian_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call log_normal_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call log_uniform_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call multinomial_sample ( a, b, c, x(1,i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    x = a + b + sqrt ( real ( i, kind = rk ) / c / 10.0D+00 )
...
!
  ...
  do i = 1, 10
    ...
    call negative_binomial_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call negative_binomial_sample ( a, b, x(i) )
  end do
...
!
  ...
  call normal_01_samples ( sample_num, x )
...
!
  ...
  call normal_samples ( sample_num, mu, sigma, x )
...
!
  ...
  do i = 1, 10
    ...
    call normal_truncated_ab_sample ( mu, s, a, b, x )
...
!
  ...
  do i = 1, sample_num
    call normal_truncated_ab_sample ( mu, s, a, b, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call normal_truncated_a_sample ( mu, s, a, x )
...
!
  ...
  do i = 1, sample_num
    call normal_truncated_a_sample ( mu, s, a, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call normal_truncated_b_sample ( mu, s, b, x )
...
!
  ...
  do i = 1, sample_num
    call normal_truncated_b_sample ( mu, s, b, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call quasigeometric_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call quasigeometric_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call reciprocal_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call semicircular_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call semicircular_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call triangle_sample ( a, b, c, x(i) )
  end do
...
!
  ...
  do i = 1, sample_num
    call triangular_sample ( a, b, x(i) )
  end do
...
!
  ...
  call uniform_01_order_sample ( n, x )
...
!
  ...
  do i = 1, 10
    call uniform_nsphere_sample ( n, x )
...
!
  ...
  do i = 1, 10
    ...
    call uniform_discrete_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call uniform_discrete_sample ( a, b, x(i) )
  end do
...
!
  ...
  do i = 1, 10
    ...
    call weibull_discrete_sample ( a, b, x )
...
!
  ...
  do i = 1, sample_num
    call weibull_discrete_sample ( a, b, x(i) )
  end do
