...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'poisson_1d_multigrid_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test poisson_1d_multigrid().'
...
!*****************************************************************************80
!
!! test01() tests poisson_1d_multigrid() on test case 1.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'test01():'
  write ( *, '(a)' ) '  poisson_1d_multigrid() solves a 1D Poisson BVP'
  ...
  do k = 5, 5
    ...
    call poisson_1d_multigrid ( n, a, b, ua, ub, force1, it_num, u )
...
!*****************************************************************************80
!
!! test02() tests poisson_1d_multigrid() on test case #2.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  do k = 5, 5
    ...
    call poisson_1d_multigrid ( n, a, b, ua, ub, force2, it_num, u )
