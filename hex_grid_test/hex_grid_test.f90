...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'hex_grid_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test hex_grid().'
!
...
!
  ...
  integer, dimension (test_num) :: nodes_per_layer_test = (/ &
...
!
  ...
  do test = 1, test_num
    ...
    temp1 = real ( layers - 1, kind = rk8 ) * hy
    temp2 = real ( layers, kind = rk8 ) * hy
...
!
  ...
  real ( kind = rk8 ), allocatable, dimension ( :, : ) :: p
  integer test
...
!
  ...
  integer n_goal
  integer nodes_per_layer
  integer, dimension (test_num) :: n_goal_test = (/ &
    100, 200, 500, 10000 /)
  integer test
...
!
  ...
  integer n
  integer nodes_per_layer
  real ( kind = rk8 ), dimension (test_num) :: h_goal_test = (/ &
