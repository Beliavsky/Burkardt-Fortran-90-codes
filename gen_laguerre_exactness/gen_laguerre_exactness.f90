...
!*****************************************************************************80
!
!! gen_laguerre_exactness() investigates a generalized Gauss-Laguerre quadrature rule.
!
!  Discussion:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'gen_laguerre_exactness():'
...
!
  if ( 3 <= arg_num ) then
    ...
    if ( alpha <= - 1.0D+00 ) then
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'gen_laguerre_exactness - Fatal error!'
      write ( *, '(a)' ) '  ALPHA <= -1.0.'
      stop
    end if
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'gen_laguerre_exactness: User input:'
...
!    Input, integer EXPON, the exponent.
!
!    Input, real ( kind = rk ) ALPHA, the exponent of X in the weight factor.
!
