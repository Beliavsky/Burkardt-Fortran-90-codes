...
!*****************************************************************************80
!
!! R8_BESJ0 evaluates the Bessel J function of order 0.
!
!  Discussion:
!
...
!*****************************************************************************80
!
!! R8_BESJ1 evaluates the Bessel J function of order 1.
!
!  Discussion:
!
!    This function computes approximate values for Bessel functions
...
!*****************************************************************************80
!
!! R8_BESY0 evaluates the Bessel Y function of order 0.
!
!  Discussion:
!
...
!*****************************************************************************80
!
!! R8_BESY1 evaluates the Bessel Y function of order 1.
!
!  Discussion:
!
!    This function computes approximate values for Bessel functions
...
!*****************************************************************************80
!
!! R8_GAMA calculates the logarithm of the gamma function.
!
!  Discussion:
!
...
!
  ...
  integer iy,j,k
  real ( kind = rk ) conv,c1,c2,c3,one
  real ( kind = rk ) ren
...
!
  ...
  real ( kind = rk ) alpha
  real ( kind = rk ) b,const,conv,em,empal,emp2al,en,enmten,ensig, &
   enten,exparg,half,halfx,one,p,plast,pold,psave,psavel, &
