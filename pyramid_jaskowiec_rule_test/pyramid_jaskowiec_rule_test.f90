...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'pyramid_jaskowiec_rule_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test pyramid_jaskowiec_rule().'

  p = 5
  call pyramid_jaskowiec_rule_test01 ( p )

  p = 5
  call pyramid_jaskowiec_rule_test02 ( p )

  p_lo = 0
  p_hi = 20
  call pyramid_jaskowiec_rule_test03 ( p_lo, p_hi )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine pyramid_jaskowiec_rule_test01 ( p )

!*****************************************************************************80
!
!! pyramid_jaskowiec_rule_test01() prints the rule of precision P.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'pyramid_jaskowiec_rule_test01():'
  write ( *, '(a)' ) '  Quadrature rule for the pyramid,'
...
!
  ...
  call pyramid_jaskowiec_rule ( p, n, x, y, z, w )
!
!  Print the rule.
!
  write ( *, '(a)' ) ''
...
subroutine pyramid_jaskowiec_rule_test02 ( p )

!*****************************************************************************80
!
!! pyramid_jaskowiec_rule_test02() tests a rule of precision P.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'pyramid_jaskowiec_rule_test02():'
...
subroutine pyramid_jaskowiec_rule_test03 ( p_lo, p_hi )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'pyramid_jaskowiec_rule_test03():'
