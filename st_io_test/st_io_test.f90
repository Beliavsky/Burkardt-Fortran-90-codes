...
!
  ...
  integer, parameter :: nst = 11

  real ( kind = rk ), dimension ( nst ) :: ast = (/ &
  ...
  integer i4vec_max
  integer i4vec_min
  integer, dimension ( nst ) :: ist = (/ &
     5, 1, 1, 3, 1, 5, 5, 2, 3, 4, 2 /)
  integer j_max
  integer j_min
  integer, dimension ( nst ) :: jst = (/ &
...
!
  ...
  real ( kind = rk ), allocatable, dimension ( : ) :: ast
  integer i_max
  integer i_min
  character ( len = 255 ) :: input_filename = 'kershaw_r8.st'
  integer, allocatable, dimension ( : ) :: ist
  integer j_max
  integer j_min
  integer, allocatable, dimension ( : ) :: jst
  integer m
  integer n
  integer nst
