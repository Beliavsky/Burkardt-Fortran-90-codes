...
!*****************************************************************************80
!
!! neighbors_to_metis_graph() converts neighbor information to a METIS GRAPH file.
!
!  Discussion:
!
...
!
  ...
  integer n_elements
  integer n_faces
  integer, allocatable, dimension ( : ) :: neighbors_of_element
...
!
!    Input, integer ISGN, results of comparison.
