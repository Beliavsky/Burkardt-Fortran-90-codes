...
!*****************************************************************************80
!
!! triangulation_quad() estimates an integral over a triangulated region.
!
!  Discussion:
!
...
!
!    Local, real ( kind = rk ) NODE_XY(DIM_NUM,NODE_NUM), the point set.
!
!    Local, real ( kind = rk ) VALUE(VALUE_DIM,VALUE_NUM), the VALUE_DIM
!    components of a vector function evaluated at each of the NODE_NUM nodes.
!
!    Local, integer VALUE_DIM, the number of components of the
!    function.
!
!    Local, integer VALUE_NUM, the number of points at which
...
!
  ...
  integer node_num
  real ( kind = rk ), allocatable :: node_xy(:,:)
