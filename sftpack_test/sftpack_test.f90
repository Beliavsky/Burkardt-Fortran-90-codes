...
!
  ...
  integer seed
  complex ( kind = rk ) x(n1,n2)
  complex ( kind = rk ) x2(n1,n2)
  complex ( kind = rk ) y(n1,n2)
...
!
  ...
  e(1:n) = e(1:n) / real ( 2 * ( n + 1 ), kind = rk )
...
!
  ...
  integer, parameter :: n = 36
! integer, parameter :: np1h = ( ( n + 1 ) / 2 )
  integer, parameter :: np1h = 18
