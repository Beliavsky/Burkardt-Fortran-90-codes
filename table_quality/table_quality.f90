...
!*****************************************************************************80
!
!! table_quality() determines quality measures for a set of points.
!
!  Discussion:
!
...
!
!    Local, real ( kind = rk ) Z(DIM_NUM,N), the point set.
!
