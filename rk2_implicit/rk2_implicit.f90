subroutine rk2_implicit ( dydt, tspan, y0, n, m, t, y )

!*****************************************************************************80
!
!! rk2_implicit() uses a Runge-Kutta order 2 implicit method + fsolve_be() to solve an ODE.
!
!  Licensing:
!
...
!
      ...
      if ( info /= 1 ) then
        write ( *, '(a)' ) ''
        write ( *, '(a)' ) 'rk2_implicit(): Fatal error!'
