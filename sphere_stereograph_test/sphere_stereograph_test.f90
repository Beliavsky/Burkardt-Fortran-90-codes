...
!
  ...
  real ( kind = rk ), allocatable :: p1(:,:)
  real ( kind = rk ), allocatable :: p2(:,:)
  real ( kind = rk ), allocatable :: q(:,:)
  real ( kind = rk ), allocatable :: q1(:,:)
  real ( kind = rk ), allocatable :: q2(:,:)
...
!
  ...
  real ( kind = rk ), allocatable :: center(:)
  real ( kind = rk ) dif
  real ( kind = rk ), allocatable :: focus(:)
  integer j
  integer m
  integer n
  real ( kind = rk ), allocatable :: p1(:,:)
