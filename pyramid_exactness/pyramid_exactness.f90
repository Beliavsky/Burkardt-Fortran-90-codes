...
!*****************************************************************************80
!
!! pyramid_exactness() checks the exactness of a pyramid quadrature rule.
!
!  Discussion:
!
...
!
!    Output, real ( kind = rk ) V(POINT_NUM), the monomial values.
!
  implicit none
...
!  Parameters:
!
!    Output, real ( kind = rk ) PYRA_UNIT_VOLUME, the volume.
!
  implicit none
