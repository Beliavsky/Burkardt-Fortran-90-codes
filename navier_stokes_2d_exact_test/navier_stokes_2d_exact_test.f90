...
!
  ...
  call r8vec_uniform_ab ( n, x_lo, x_hi, x )
  call r8vec_uniform_ab ( n, y_lo, y_hi, y )
  t = 0.0D+00
...
!
  ...
  do j = 1, 3
    ...
    do k = 0, 5
      ...
      t = real ( k, kind = rk ) / 5.0D+00

      call uvp_poiseuille ( nu, rho, n, x, y, t, u, v, p )

      u_norm = r8vec_norm_l2 ( n, u ) / real ( n, kind = rk )
      v_norm = r8vec_norm_l2 ( n, v ) / real ( n, kind = rk )
      p_norm = r8vec_norm_l2 ( n, p ) / real ( n, kind = rk )
