...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_witherden_rule_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test prism_witherden_rule().'

  p = 5
  call prism_witherden_rule_test01 ( p )

  p = 5
  call prism_witherden_rule_test02 ( p )

  p_lo = 0
  p_hi = 10
  call prism_witherden_rule_test03 ( p_lo, p_hi )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine prism_witherden_rule_test01 ( p )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_witherden_rule_test01():'
  write ( *, '(a)' ) '  Quadrature rule for the unit prism,'
...
!
  ...
  call prism_witherden_rule ( p, n, x, y, z, w )
!
!  Print the rule.
!
  write ( *, '(a)' ) ''
...
subroutine prism_witherden_rule_test02 ( p )

!*****************************************************************************80
!
!! prism_witherden_rule_test02() tests a quadrature rule of precision P.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_witherden_rule_test02():'
  write ( *, '(a)' ) '  Test the precision of a quadrature rule for the unit prism,'
...
!
  ...
  do degree = 0, p + 2
    ...
    do while ( .true. )
      ...
      quad = prism_unit_volume ( ) * dot_product ( w, v )
 
      call prism_unit_monomial_integral ( expon, exact )
...
subroutine prism_witherden_rule_test03 ( p_lo, p_hi )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'prism_witherden_rule_test03():'
  write ( *, '(a)' ) '  Test the precision of quadrature rules for the unit prism,'
