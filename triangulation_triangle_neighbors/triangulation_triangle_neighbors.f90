...
!*****************************************************************************80
!
!! TRIANGULATION_TRIANGLE_NEIGHBORS() identifies neighboring triangles..
!
!  Discussion:
!
!    The code determines the neighbor triangles of each triangle in a
!    triangulation.
!
...
!
  ...
  integer node_num
  real ( kind = rk8 ), allocatable, dimension ( :, : ) :: node_xy
