...
!
  ...
  do i = -20, 20
    ...
    x = mu + sigma * real ( i, kind = rk ) / 10.0D+00
...
!
  ...
  real ( kind = rk ) b
  real ( kind = rk ), dimension ( 6 ) :: b_test = (/ &
    0.0D+00, 10.0D+00, -10.0D+00, 10.0D+00, -10.0D+00, 10.0D+00 /)
  real ( kind = rk ) moment
  real ( kind = rk ) mu
  real ( kind = rk ), dimension ( 6 ) :: mu_test = (/ &
