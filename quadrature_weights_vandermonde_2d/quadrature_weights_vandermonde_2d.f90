subroutine quadrature_weights_vandermonde_2d ( t, n, a, b, c, d, x, y, w )

!*****************************************************************************80
!
!! quadrature_weights_vandermonde_2d() computes 2D quadrature weights using the Vandermonde matrix.
!
!  Discussion:
!
