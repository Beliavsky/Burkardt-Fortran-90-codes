...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'gauss_seidel_test():'
  write ( *, '(a)' ) '  FORTRAN90 version.'
  write ( *, '(a)' ) '  Test gauss_seidel().'
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'gauss_seidel_test01():'
  write ( *, '(a)' ) '  Try the gauss_seidel iteration on the second difference matrix'
...
!
  do it = 1, it_max
    ...
    call gauss_seidel1 ( n, a, b, x, x_new )
