...
!  Parameters:
!
!    Input, integer N, the order of the master set.
!
!    Input, integer T, the set.
!
!    Output, integer RANK, the rank of the set.
!
  implicit none
...
!    Input, integer N, the order of the master set.
!
!    Input/output, integer T, describes a set.  
...
!  Parameters:
!
!    Input, integer RANK, the rank of the set.
!
!    Input, integer N, the order of the master set.
!
!    Output, integer T, the set of the given rank.
!
  implicit none
...
!    Input, integer N, the order of the master set.
!
!    Input, integer A, the set.
!
!    Output, integer B, the complement of A.
!
  implicit none
...
!    Input, integer A, the set.
!
!    Input, integer B, the set with respect to which 
!    the complement is taken.
!
!    Output, integer C, the complement of A with respect to B.
!
  implicit none
...
!    Input, integer N, the order of the master set.
!
!    Input, integer A, an item.
!
!    Input/output, integer T, a set.
!
  implicit none
...
!    Input, integer N, the order of the master set.
!
!    Output, integer SET_NUM, the number of distinct sets.
!
  implicit none
...
!    Input, integer N, the order of the master set.
!
!    Input, integer A, the item.
!
!    Input, integer T, a set.
!
...
!    Input, integer N, the order of the master set.
!
!    Input, integer A, B, two sets.
!
!    Output, integer C, the intersection of A and B.
!
  implicit none
...
!    number generator.
!
!    Output, integer A, the random B4SET.
!
  implicit none
...
!    Input, integer A, B, two sets.
!
!    Output, integer C, the union of A and B.
!
  implicit none
...
!    Input, integer T, the set.
!
!    Output, integer WEIGHT, the Hamming weight of the set T.
!
  implicit none
...
!    Input, integer A, B, two sets.
!
!    Output, integer C, the symmetric difference of A and B.
!
  implicit none
...
!  Parameters:
!
!    Input, integer N_NUM, the number of numeric entries.
!
!    Input, integer A_NUM(N_NUM), the numeric vector.
!    Entries of A_NUM should be between 1 and 32.
!
!    Input, integer N, the order of the master set.
!    N <= 32.
!
!    Output, integer A, the corresponding B4SET.
!
  implicit none
