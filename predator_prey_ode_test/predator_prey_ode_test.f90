...
!  Input:
!
!    real ( kind = rk ) TSPAN(2) = [ T0, TMAX ], the initial and final times.
!    A reasonable value might be [ 0, 5 ].
!
!    real ( kind = rk ) P0(2) = [ PREY, PRED ], the initial number of prey and predators.
...
!    A reasonable value might be [ 0, 5 ].
!
!    real ( kind = rk ) P0 = [ PREY, PRED ], the initial number of prey and predators.
!    A reasonable value might be [ 5000, 100 ].
!
!    integer N: the number of time steps.
!
