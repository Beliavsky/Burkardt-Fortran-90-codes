...
!*****************************************************************************80
!
!! square_hex_grid_test() tests square_hex_grid().
!
!  Licensing:
!
...
!
  ...
  do test = 1, test_num
    ...
    temp1 = real ( layers - 1, kind = rk ) * hy
    temp2 = real ( layers, kind = rk ) * hy
...
!
  ...
  integer n
  integer nodes_per_layer
  real ( kind = rk ), dimension (test_num) :: h_goal_test = (/ &
