...
!
  ...
  integer, allocatable, dimension ( :, : ) :: element_neighbor
  integer, allocatable, dimension ( :, : ) :: element_node_t3
  integer, allocatable, dimension ( :, : ) :: element_node_t6
  integer element_num
  integer element_order_t3
  integer element_order_t6
  integer element2
  integer i
  integer i4_wrap
  integer iarg
  ...
  integer node_num_t3
  integer node_num_t6
  real ( kind = rk ), allocatable, dimension ( :, : ) :: node_xy_t3
  real ( kind = rk ), allocatable, dimension ( :, : ) :: node_xy_t6
