...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'hexahedron_jaskowiec_rule_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test hexahedron_jaskowiec_rule().'

  p = 5
  call hexahedron_jaskowiec_rule_test01 ( p )

  p = 5
  call hexahedron_jaskowiec_rule_test02 ( p )

  p_lo = 0
  p_hi = 21
  call hexahedron_jaskowiec_rule_test03 ( p_lo, p_hi )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine hexahedron_jaskowiec_rule_test01 ( p )

!*****************************************************************************80
!
!! hexahedron_jaskowiec_rule_test01() prints the rule of precision P.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'hexahedron_jaskowiec_rule_test01():'
  write ( *, '(a)' ) '  Quadrature rule for the hexahedron,'
...
!
  ...
  call hexahedron_jaskowiec_rule ( p, n, x, y, z, w )
!
!  Print the rule.
!
  write ( *, '(a)' ) ''
  ...
  write ( *, '(a)' ) ''
  do i = 1, n
    write ( *, '(2x,i4,2x,f10.6,2x,f10.6,2x,f10.6,2x,f10.6)' ) &
      i, w(i), x(i), y(i), z(i)
  end do
!
...
subroutine hexahedron_jaskowiec_rule_test02 ( p )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'hexahedron_jaskowiec_rule_test02():'
...
subroutine hexahedron_jaskowiec_rule_test03 ( p_lo, p_hi )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'hexahedron_jaskowiec_rule_test03():'
  write ( *, '(a)' ) '  Test the precision of quadrature rules for the unit hexahedron,'
