...
!  Read the data.
!
  call r8mat_header_read ( 'grid_data.txt', m, nn )

  allocate ( xyz(1:m,1:nn) )

  call r8mat_data_read ( 'grid_data.txt', m, nn, xyz )
!
!  Split the data.
!
  n = 41
...
!
  call graf3d ( - 2.0D+00, + 2.0D+00, - 2.0D+00, 0.5D+00, &
                - 2.0D+00, + 2.0D+00, - 2.0D+00, 0.5D+00, &
                - 0.4D+00, + 0.4D+00, - 0.4D+00, 0.1D+00 )
!
