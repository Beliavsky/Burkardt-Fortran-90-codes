...
!*****************************************************************************80
!
!! lynx_plot() uses dislin() to plot the yearly lynx harvest.
!
!  Discussion:
!
...
!  Read the data.
!
  call r8mat_header_read ( 'lynx_data.txt', m, n )

  allocate ( xy(1:m,1:n) )

  call r8mat_data_read ( 'lynx_data.txt', m, n, xy )
!
...
!
  call graf ( 1821.0D+00, 1934.0D+00, 1830.0D+00, 10.0D+00, 0.0D+00, &
    7000.0D+00, 0.0D+00, 1000.0D+00 )
!
