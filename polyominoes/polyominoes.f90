...
!    'u', 'v', 'w', 'x', 'y' or 'z'.
!
!    Output, integer P_M, P_N, the number of rows and columns of 
!    the representation.
!
!    Output, integer P(P_Mp_N), a P_MxP_N matrix of 0's and 1's 
...
!
  ...
  integer, save :: f_mat(3*3) = (/ &
     0, 1, 0, &
     1, 1, 1, &
     1, 0, 0 /)
  integer, save :: i_mat(5*1) = (/ &
    1, 1, 1, 1, 1 /)
  integer, save :: l_mat(4*2) = (/ &
    1, 1, 1, 1, &
    0, 0, 0, 1 /)
  integer, save :: n_mat(2*4) = (/ &
    1, 0, &
    1, 1, &
    0, 1, &
    0, 1 /)
  integer, save :: p_mat(3*2) = (/ &
    1, 1, 1, &
    1, 1, 0 /)
  integer, save :: t_mat(3*3) = (/ &
    1, 0, 0, &
    1, 1, 1, &
    1, 0, 0 /)
  integer, save :: u_mat(2*3) = (/ &
    1, 1, &
    0, 1, &
    1, 1 /)
  integer, save :: v_mat(3*3) = (/ &
    1, 1, 1, &
    0, 0, 1, &
    0, 0, 1 /)
  integer, save :: w_mat(3*3) = (/ &
    1, 1, 0, &
    0, 1, 1, &
    0, 0, 1 /)
  integer, save :: x_mat(3*3) = (/ &
    0, 1, 0, &
    1, 1, 1, &
    0, 1, 0 /)
  integer, save :: y_mat(2*4) = (/ &
    0, 1, &
    0, 1, &
    1, 1, &
    0, 1 /)
  integer, save :: z_mat(3*3) = (/ &
    1, 0, 0, &
    1, 1, 1, &
    0, 0, 1 /)
...
!  Parameters:
!
!    Input, integer P_M, P_N, the number of rows and columns of the
!    representation.
!
...
!  Parameters:
!
!    Input, integer MP, NP, the number of rows and columns in the 
!    representation of the polyomino P.
!
!    Input, integer P(MP*NP), a matrix of 0's and 1's representing 
!    the polyomino.  
!
...
!  Parameters:
!
!    Input, integer MR, NR, the number of rows and columns in the 
!    representation of the region R.
!
!    Input, integer R(MR,NR), a matrix of 0's and 1's 
...
!
!    Output, integer LIST(NUMBER,2), for each embedding, the I and 
...
!  Parameters:
!
!    Input, integer MR, NR, the number of rows and columns in
!    the representation of the region R.
!
!    Input, integer R[MR*NR], a matrix of 0's and 1's representing
!    the region.
!
!    Input, integer MP, NP, the number of rows and columns in the 
!    representation of the polyomino P.
!
!    Input, integerv P[MP*NP], a matrix of 0's and 1's 
!    representing the polyomino.
!
!    Output, integer POLYOMINO_EMBED_NUMBER, the number of 
...
!
!    Output, integer ( kind = rk ) NUMBER, the number of chiral polyominos 
!    of this order.
!
  implicit none
  ...
  integer n_data
  integer ( kind = rk ) number
  integer ( kind = rk ), save, dimension ( n_max ) :: number_vec = (/ & 
    1_8, & 
    1_8, &
    1_8, &
    2_8, &
...
!    Output, integer ORDER, the order of a polyomino.
!
!    Output, integer ( kind = rk ) NUMBER, the number of fixed polyominos 
!    of this order.
!
  implicit none
...
!
!    Output, integer NUMBER ( kind = rk ), the number of free polyominos of 
!    this order.
!
  implicit none
...
!
!    Input, integer P(M*N), the polyomino.  It is assumed that 
...
!  Parameters:
!
!    Input, integer M, N, the number of rows and columns in the system.
!
!    Output, integer A(M,N), the system matrix.
!
!    Output, integer B(M), the right hand side.
!
  implicit none
...
!    representation of the polyomino P.
!
!    Input, integer P(M*N), a matrix of 0's and 1's representing 
...
!    1 in row 1, and in column 1, and in row M, and in column N.
!
!    Input, integer ROTATE, is 0, 1, 2, or 3, the number of 90 
!    degree counterclockwise rotations to be applied.
!
!    Input, integer REFLECT, is 0 or 1.  If it is 1, then each row 
!    of the polyomino matrix is to be reflected before any rotations are 
!    performed.
!
!    Output, integer *MQ, *NQ, the number of rows and columns of 
!    the representation of the transformed polyomino
!
!    Output, integer Q[MQ*NQ], the representation of the 
