...
!
  ...
  real delta(n_log_min:n_log_max,rep_num+3)
  integer n
  integer n_log
  integer rep
  real time1
  ...
  do n_log = n_log_min, n_log_max
    ...
    delta(n_log,rep_num+2) = sum    ( delta(n_log,1:rep_num) ) / real ( rep_num )
