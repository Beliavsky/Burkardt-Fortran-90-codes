...
!
  ...
  integer, parameter :: call_num = 100
  integer clock_count
  ...
  write ( *, '(a)' ) '  integer type of the arguments.'
  ...
  write ( *, '(a)' ) ' '
  tmax = real ( clock_max ) / real ( clock_rate )
  ...
  write ( *, '(a,g14.6,a)' ) &
    ...
    real ( clock_count2 - clock_count1 ) &
    / real ( call_num * clock_rate ), ' seconds'
...
!
  ...
  integer, parameter :: n_log_min = 10
  integer, parameter :: n_log_max = 20
  integer, parameter :: n_min = 2**n_log_min
  integer, parameter :: n_max = 2**n_log_max
  integer, parameter :: n_rep = 5
  ...
  do i_rep = 1, n_rep
    ...
    do n_log = n_log_min, n_log_max
      ...
      delta(n_log,i_rep) = real ( clock_stop - clock_start ) &
        / real ( clock_rate )
...
!
  ...
  integer, parameter :: n_log_min = 12
  integer, parameter :: n_log_max = 22
  integer, parameter :: n_min = 2**n_log_min
  integer, parameter :: n_max = 2**n_log_max
  integer, parameter :: n_rep = 5
...
!
  ...
  integer, parameter :: l_log_min = 1
  integer, parameter :: l_log_max = 5
  integer, parameter :: l_min = 4**l_log_min
  integer, parameter :: l_max = 4**l_log_max
  ...
  integer clock_start
  integer clock_stop
  real delta(l_log_min:l_log_max,rep_num)
  integer i
  integer j
  integer k
  integer l
  ...
  do rep = 1, rep_num
    ...
    do l_log = l_log_min, l_log_max - 1
      ...
      delta(l_log,rep) = real ( clock_stop - clock_start ) &
        / real ( clock_rate )
