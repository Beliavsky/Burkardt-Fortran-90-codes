...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'midpoint_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test midpoint().'
...
!*****************************************************************************80
!
!! humps_test() calls midpoint() for the humps problem.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  call midpoint ( humps_deriv, tspan, y0, n, m, t, y )
...
!
  ...
  write ( command_unit, '(a)' ) 'set title "midpoint(): Humps ODE"'
...
!*****************************************************************************80
!
!! predator_prey_test(): predator-prey using midpoint().
!
!  Discussion:
!
...
!
  ...
  call midpoint ( predator_prey_dydt, tspan, y0, n, m, t, y )
!
!  Create the data file.
!
  call get_unit ( data_unit )
...
!*****************************************************************************80
!
!! stiff_test() uses the midpoint method on the stiff ODE.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'stiff_test():'
  write ( *, '(a)' ) '  Solve stiff ODE using midpoint()'

  call midpoint ( stiff_dydt, tspan, y0, n, m, t1, y1 )
