...
!
  ...
  real ( kind = rk8 ), allocatable, dimension ( :, : ) :: node_coord
  real ( kind = rk8 ), allocatable, dimension ( :, : ) :: node_data
  ...
  call tec_header_read ( tec_file_unit, dim_num, node_num, &
  ...
  call tec_data_read ( tec_file_unit, dim_num, &
...
!
  ...
  real ( kind = rk8 ), dimension ( dim_num, node_num ) :: node_coord = &
    reshape ( (/ &
    0.0, 0.0, &
    1.0, 0.0, &
    2.0, 0.0, &
  ...
  real ( kind = rk8 ), dimension ( node_data_num, node_num ) :: node_data = &
    reshape ( (/ &
    1.0, 0.0, &
    0.8, 0.2, &
    0.6, 0.4, &
  ...
  call tec_write ( dim_num, node_num, element_num, &
