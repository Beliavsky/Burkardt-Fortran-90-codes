...
!
  ...
  integer, parameter :: o1 = 6
  integer, parameter :: o2 = 5
  integer, parameter :: o_max = o1 + o2
...
!
  ...
  real ( kind = rk ), save, dimension ( o ) :: c = (/ &
    7.0, - 5.0, 5.0, 9.0, 11.0, 3.0, 6.0, 0.0, - 13.0, 1.0E-20 /)
  real ( kind = rk ) c2(o)
  integer, save, dimension ( o ) :: e = (/ &
...
!
  ...
  integer, parameter :: o1 = 4
  integer, parameter :: o_max = o1
