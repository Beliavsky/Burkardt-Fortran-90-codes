...
!*****************************************************************************80
!
!! quadrature_weights_vandermonde_2d_test() tests quadrature_weights_vandermonde_2d().
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'quadrature_weights_vandermonde_2d_test():'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test quadrature_weights_vandermonde_2d().'
...
!*****************************************************************************80
!
!! TEST01 tests quadrature_weights_vandermonde_2d for a trio of points.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!  Compute the weights.
!
  call quadrature_weights_vandermonde_2d ( t, n, a, b, c, d, x, y, w )
...
!*****************************************************************************80
!
!! TEST02 tests quadrature_weights_vandermonde_2d for Padua points
!
!  Licensing:
!
!    This code is distributed under the MIT license.
