...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'trapezoidal_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test trapezoidal().'
...
!*****************************************************************************80
!
!! predator_prey_test(): predator-prey using trapezoidal().
!
!  Discussion:
!
...
!
  ...
  write ( *, '(a)' ) '  of predators and prey are solved using trapezoidal().'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  The exact solution shows periodic behavior, with a fixed'
  write ( *, '(a)' ) '  period and amplitude.'

  call trapezoidal ( predator_prey_dydt, tspan, y0, n, m, t, y )
!
...
!*****************************************************************************80
!
!! stiff_test() uses the trapezoidal method on the stiff ODE.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'stiff_test():'
  write ( *, '(a)' ) '  Solve stiff ODE using trapezoidal()'

  call trapezoidal ( stiff_dydt, tspan, y0, n, m, t1, y1 )
