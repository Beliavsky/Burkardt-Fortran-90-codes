...
!
  ...
  integer, allocatable, dimension ( :, : ) :: triangle_node1
  integer, allocatable, dimension ( :, : ) :: triangle_node2
...
!  Parameters:
!
!    Input, integer TRI_NUM1, the number of triangles in the 
!    quadratic triangulation.
!
!    Input, integer TRIANGLE1(6,TRI_NUM1), the quadratic
!    triangulation.
!
!    Input, integer TRI_NUM2, the number of triangles in the linear
!    triangulation.  TRI_NUM2 = 4 * TRI_NUM1.
!
!    Output, integer TRIANGLE2(3,TRI_NUM2), the linear 
!    triangulation.
!
  implicit none
  ...
  integer tri1
  integer tri2
  integer triangle1(6,tri_num1)
  integer triangle2(3,tri_num2)
