...
!
  ...
  call chi_measure_test ( dim_num, n, z, ns, sample_hypercube_uniform, seed_init )
  call d_measure_test ( dim_num, n, z, ns, sample_hypercube_uniform, seed_init )
...
!
  ...
  call test007 ( dim_num, n, z )
  call chi_measure_test ( dim_num, n, z, ns, sample_sphere_uniform, seed_init )
  call d_measure_test ( dim_num, n, z, ns, sample_sphere_uniform, seed_init )
...
subroutine chi_measure_test ( dim_num, n, z, ns, sample_routine, seed_init )

!*****************************************************************************80
!
!! chi_measure_test tests CHI_MEASURE.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
subroutine d_measure_test ( dim_num, n, z, ns, sample_routine, seed_init )

!*****************************************************************************80
!
!! d_measure_test tests D_MEASURE.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
