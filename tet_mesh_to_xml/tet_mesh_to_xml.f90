...
!
  ...
  write ( *, '(a)' ) '  Convert a linear or quadratic tet mesh to DOLFIN XML mesh format.'

  write ( *, '(a)' ) '  Read "prefix"_nodes.txt, node coordinates.'
  write ( *, '(a)' ) &
    '  Read "prefix"_elements.txt, 4 or 10 node element definitions.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  Create "prefix".xml, a corresponding DOLFIN XML mesh file.'
!
...
!
  ...
  write ( xml_unit, '(a)' ) '  <mesh celltype="tetrahedron" dim="3">'

  write ( xml_unit, '(a,i6,a)' ) '    <vertices size="', node_num, '">'
  do node = 1, node_num
  ...
  write ( xml_unit, '(a,i6,a)' ) '    <cells size="', element_num, '">'
