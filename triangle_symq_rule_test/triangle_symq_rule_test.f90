...
!
  ...
  write ( *, '(a)' ) '  Test triangle_symq_rule().'

  p = 5
  call triangle_symq_rule_test01 ( p )

  p = 5
  call triangle_symq_rule_test02 ( p )

  p_lo = 0
  p_hi = 50
  call triangle_symq_rule_test03 ( p_lo, p_hi )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine triangle_symq_rule_test01 ( p )

!*****************************************************************************80
!
!! triangle_symq_rule_test01() computes a quadrature rule of given order.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'triangle_symq_rule_test01():'
...
!
  ...
  call triangle_symq_rule ( p, n, a, b, c, w )
!
!  Print the rule.
!
  write ( *, '(a)' ) ''
...
subroutine triangle_symq_rule_test02 ( p )

!*****************************************************************************80
!
!! triangle_symq_rule_test02() tests a triangle quadrature rule.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
  ...
  integer t
  real ( kind = 8 ) triangle_unit_area
  real ( kind = 8 ) triangle_unit_monomial_integral
  real ( kind = rk ), allocatable :: v(:)
  real ( kind = rk ), allocatable :: w(:)
  real ( kind = rk ), allocatable :: xy(:,:)

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'triangle_symq_rule_test02():'
...
subroutine triangle_symq_rule_test03 ( p_lo, p_hi )

!*****************************************************************************80
!
!! triangle_symq_rule_test03() tests absolute and relative precision.
!
!  Licensing:
!
!    This code is distributed under the GNU GPL license.
...
!
    ...
    do degree = 0, p
      ...
      do while ( .true. )
        ...
        max_rel = max ( max_rel, quad_error / exact )
