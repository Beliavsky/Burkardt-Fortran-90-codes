...
!
  ...
  write ( *, '(a)' ) '  Test tsp_lau().'

  call test01 ( 'five.txt' )
  call test01 ( 'fifteen.txt' )
  call test01 ( 'seventeen.txt' )
! call test01 ( 'fortyeight.txt' )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
!*****************************************************************************80
!
!! test01() tests tsp() on a particular file.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  real ( kind = rk ), allocatable :: distance(:,:)
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'test01():'
  write ( *, '(a)' ) '  tsp() is to be applied to the distance table stored in'
  write ( *, '(a)' ) '  the file "' // filename // '"'
!
...
!
  ...
  call r8mat_data_read ( filename, n, n, distance )
!
