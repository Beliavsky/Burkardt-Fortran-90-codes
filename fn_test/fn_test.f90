...
!
  ...
  real ( kind = rk ), parameter :: r8_pi =  3.141592653589793238462643383279503D+00
  real ( kind = rk ), save :: expcs(15) = (/ &
...
!
  ...
  integer i
  integer, save, dimension ( 7 ) :: i_value = (/ &
    1, 2, 3, 4, 10, 100, 1000 /)
  integer ix0
  integer ix1
  integer k
  real ( kind = rk ) r
  real ( kind = rk ), save, dimension ( 7 ) :: r_value = (/ &
    0.0004127026D+00, &
    0.6750836372D+00, &
    0.1614754200D+00, &
    0.9086198807D+00, &
