...
!    Input, integer N, the order of the matrix.
!
!    Output, complex ( kind = ck ) EXPA(N,N), the exponential of the test matrix.
!
  implicit none
...
!    Input, integer N, the order of the matrix.
!
!    Output, real ( kind = rk ) EXPA(N,N), the exponential of the test matrix.
!
  implicit none
